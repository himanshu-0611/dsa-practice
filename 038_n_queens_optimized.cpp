class Solution {
public:
    unordered_map<int, bool>leftHoriCheck;
    ...
    bool isSafe(int row, int col, vector<vector<char>> &board) {
        ...
        //leftHoriCheck
        if(leftHoriCheck[row] == true) {
            //same row me pehelese koi Q baithi h - attack hoga
            return false;
        }
        //upper diag
